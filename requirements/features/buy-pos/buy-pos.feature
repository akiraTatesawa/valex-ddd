...
Funcionalidade: Compra em Points of Sale
 A fim de realizar uma compra
 Como um funcionário
 Eu quero poder pagar uma compra utilizando Points of Sale (POS)
    ...
    Cenario: Funcionário falha ao realizar compra com a senha errada do cartão
     ...
     Mas a senha do cartão esteja incorreta
      Entao o funcionário não deve ser capaz de realizar uma compra
      E o funcionário recebe uma mensagem de erro informando que a senha do cartão está incorreta
